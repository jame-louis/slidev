import{o as n,e as r,g as i,F as v,aj as g,n as m,t as o,r as b,z as y,b as u,w as k,d as _,v as h,x as z,T as l}from"./modules/vue-ay11y6SF.js";import{u as x,f as w}from"./slidev/context-BdDbqE1l.js";import{_ as j}from"./index-Di-nA1tJ.js";import{I as C}from"./slidev/default-rY9BvfqM.js";import"./modules/shiki-D6djOZTy.js";const $={class:"utility-examples"},B={class:"tabs"},E=["onClick"],F={class:"content"},L={class:"code-panel"},T={class:"preview-panel"},I=["innerHTML"],P={__name:"UtilityExamples",setup(c){x();const e=[{title:"间距工具",code:`<div class="m-0">无外边距</div>
...
<div class="p-2 bg-dark text-white">.bg-dark</div>`,preview:`
    ...
    `}],d=b(0),s=y(()=>e[d.value]);return(a,t)=>(n(),r("div",$,[i("div",B,[(n(),r(v,null,g(e,(f,p)=>i("button",{key:p,class:m(["tab-btn",{active:d.value===p}]),onClick:N=>d.value=p},o(f.title),11,E)),64))]),i("div",F,[i("div",L,[i("pre",null,[i("code",null,o(s.value.code),1)])]),i("div",T,[t[0]||(t[0]=i("div",{class:"preview-label"},"实时效果",-1)),i("div",{class:"preview-inner",innerHTML:s.value.preview},null,8,I)])])]))}},H=j(P,[["__scopeId","data-v-ea78bae0"]]),M={class:"mt-4"},q={__name:"slides.md__slidev_36",setup(c){const{$clicksContext:e,$frontmatter:d}=x();return e.setup(),(s,a)=>{const t=H;return n(),u(C,h(z(l(w)(l(d),35))),{default:k(()=>[a[0]||(a[0]=i("h2",null,"间距、Flexbox、颜色工具",-1)),i("div",M,[_(t)])]),_:1},16)}}};export{q as default};
