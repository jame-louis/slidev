import{o as i,e as r,g as a,F as b,aj as g,n as x,t as c,r as u,z as m,b as h,w as y,d as _,v as w,x as k,T as d}from"./modules/vue-DLk4nEN5.js";import{u as p,f as z}from"./slidev/context-DDWznW3L.js";import{_ as N}from"./index-CKQ4BFgO.js";import{I as C}from"./slidev/default-BbsIbo65.js";import"./modules/shiki-DWU4f0zh.js";const j={class:"navbar-examples"},$={class:"tabs"},B=["onClick"],E={class:"content"},L={class:"code-panel"},T={class:"preview-panel"},I=["innerHTML"],P={__name:"NavbarExamples",setup(v){p();const t=[{title:"主色导航栏",code:`<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container">
  ...
  <div class="container-fluid">
    ...
    `}],e=u(0),s=m(()=>t[e.value]);return(l,n)=>(i(),r("div",j,[a("div",$,[(i(),r(b,null,g(t,(f,o)=>a("button",{key:o,class:x(["tab-btn",{active:e.value===o}]),onClick:M=>e.value=o},c(f.title),11,B)),64))]),a("div",E,[a("div",L,[a("pre",null,[a("code",null,c(s.value.code),1)])]),a("div",T,[n[0]||(n[0]=a("div",{class:"preview-label"},"实时效果",-1)),a("div",{class:"preview-inner",innerHTML:s.value.preview},null,8,I)])])]))}},F=N(P,[["__scopeId","data-v-068cc1e4"]]),H={class:"mt-4"},A={__name:"slides.md__slidev_38",setup(v){const{$clicksContext:t,$frontmatter:e}=p();return t.setup(),(s,l)=>{const n=F;return i(),h(C,w(k(d(z)(d(e),37))),{default:y(()=>[l[0]||(l[0]=a("h2",null,"导航栏（Navbar）",-1)),a("div",H,[_(n)])]),_:1},16)}}};export{A as default};
