import{o as a,e as t,j as v,g as l,F as x,aj as f,n as w,t as r,r as u,z as g,b as h,w as b,d as y,v as C,x as k,T as m}from"./modules/vue-DLk4nEN5.js";import{u as n,f as T}from"./slidev/context-DDWznW3L.js";import{_ as $}from"./index-CKQ4BFgO.js";import{I as z}from"./slidev/default-BbsIbo65.js";import"./modules/shiki-DWU4f0zh.js";const B={class:"grid-examples"},E={class:"tabs"},L=["onClick"],j={class:"content"},I={class:"code-panel"},N={class:"preview-panel"},P=["innerHTML"],S={__name:"GridExamples",setup(p){n();const o=[{title:"基础结构",code:`<div class="container">
  <div class="row">
...
<div class="row mt-2">
  ...
  <div class="col-12 col-md-6 col-lg-3">卡片4</div>
    ...
    `}],s=u(0),i=g(()=>o[s.value]);return(c,d)=>(a(),t("div",B,[v(" Tabs "),l("div",E,[(a(),t(x,null,f(o,(_,e)=>l("button",{key:e,class:w(["tab-btn",{active:s.value===e}]),onClick:G=>s.value=e},r(_.title),11,L)),64))]),v(" Content: left code, right preview "),l("div",j,[l("div",I,[l("pre",null,[l("code",null,r(i.value.code),1)])]),l("div",N,[d[0]||(d[0]=l("div",{class:"preview-label"},"实时效果",-1)),l("div",{class:"preview-inner",innerHTML:i.value.preview},null,8,P)])])]))}},V=$(S,[["__scopeId","data-v-10f98efe"]]),F={class:"mt-4"},A={__name:"slides.md__slidev_24",setup(p){const{$clicksContext:o,$frontmatter:s}=n();return o.setup(),(i,c)=>{const d=V;return a(),h(z,C(k(m(T)(m(s),23))),{default:b(()=>[c[0]||(c[0]=l("h2",null,"栅格系统的三层结构",-1)),l("div",F,[y(d)])]),_:1},16)}}};export{A as default};
